...
inb5 = InlineKeyboardButton(text='🏡Бытовые траты🏡', callback_data='cat_5')
inb6 = InlineKeyboardButton(text='💳Прочее💳', callback_data='cat_6')
inb7 = InlineKeyboardButton(text='❌ОТМЕНА❌', callback_data='cat_cancel')

kb_client = ReplyKeyboardMarkup(resize_keyboard=True)
inkb_client = InlineKeyboardMarkup(row_width=1)

kb_client.add(b1).add(b2).add(b3)
inkb_client.add(inb1).add(inb2).add(inb3).add(inb4).add(inb5).add(inb6).add(inb7)
